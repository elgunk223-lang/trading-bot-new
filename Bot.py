...
# --- RENDER ÜÇÜN FLASK SERVERİ (7/24 uyanıq qalmaq üçün) ---
app = Flask('')
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            print(f"Şəbəkə xətası baş verdi: {e}. 5 saniyə sonra yenidən qoşulur...")
            time.sleep(5)
